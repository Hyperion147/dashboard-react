...
export function AdminOverview() {
    ...
    const { data: projectTaskStats, isLoading: isProjectTaskLoading } =
        useQuery({
    ...
    return (
        <div ref={containerRef} className="space-y-4 p-4">
            ...
            <Card
                ref={quickActionsRef}
                className="initial-animation dashboard-card shadow-sm border hover:shadow-md transition-shadow"
            >
                <CardHeader>
                            ...
                            <CardContent>
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-2xl font-bold">
                                            {projectTaskStats?.activeProjects ||
                                                0}
                                        </p>
                                    </div>
                            ...
                            <div className="space-y-4">
                                {Array.isArray(employeeStats?.departments) &&
                                    employeeStats.departments.map((dept) => (
                                        <div
                                            key={dept.name}
                                            className="animate-item space-y-2"
                                        >
                                            <div className="flex items-center justify-between">
