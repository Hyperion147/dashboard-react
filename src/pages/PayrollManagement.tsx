...
export function PayrollManagement() {
    ...
    return (
        <div ref={containerRef} className="space-y-6 p-4">
            {/* Header */}
            <div className="initial-animation flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
            ...
            <Card className="initial-animation">
                <CardHeader>
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <CardTitle className="initial-animation">
                            Payroll Records
                        </CardTitle>
                        <div className="flex gap-2">
                            <div className="relative flex-1 sm:flex-none initial-animation">
                            ...
                            >
                                <SelectTrigger className="w-32 initial-animation">
                    ...
                    {isLoading ? (
                        ...
                        <div className="space-y-3">
                            {filteredPayrolls.map((payroll) => {
                                ...
                                const payrollId =
                                    payroll.id || (payroll as any).payroll_id;
